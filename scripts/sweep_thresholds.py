#!/usr/bin/env python
"""Sweep mask and boundary thresholds for a trained checkpoint."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--boundary-thresholds", default="0.30,0.40,0.50,0.60,0.70,0.80")
...
def main() -> None:
    ...
    for mask_th in mask_thresholds:
        ...
        for sample in samples:
            mask_metrics.append(confusion_metrics(sample["mask_gt"], sample["mask_prob"] >= mask_th))
